...
class _DoctorProfileViewState extends State<DoctorProfileView> {
  ...
  void initState() {
    ...
    _namaController.text = (provider.user() as DoctorModel).nama;
    _spesialisasiController.text =
        (provider.user() as DoctorModel).spesialisasi;
    _rumahSakitController.text =
        (provider.user() as DoctorModel).rumahSakit;
    _biodataController.text = (provider.user() as DoctorModel).biodata;
    _nomorTeleponController.text =
        (provider.user() as DoctorModel).nomorTelepon;
    fotoUrl = (provider.user() as DoctorModel).foto;
  }
  ...
  Future<void> _changeProfile() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await authProvider.changeDoctorProfile(
        ...
        Navigator.pushReplacementNamed(context, RouteConstant.doctor_homeView);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      label: 'Spesialisasi',
                      hint: 'Contoh: Dokter Umum, Dokter Anak, dll',
                    ...
                    _buildTextField(
                      ...
                      label: 'Biodata',
                      hint: 'Ceritakan tentang pengalaman dan keahlian Anda',
              ...
              Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).pushNamed(RouteConstant.doctor_changeLocationView);
                      },
                      style: ElevatedButton.styleFrom(
