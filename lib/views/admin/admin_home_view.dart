...
import 'package:docify/views/admin/admin_doctor_management_view.dart';
import 'package:docify/views/admin/admin_patient_management_view.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: TabBarView(
          ...
          children: [
            AdminDoctorManagementView(),
            AdminPatientManagementView(),
          ],
        ),
      ),
