...
class PatientAppointmentManagementView extends StatefulWidget {
  const PatientAppointmentManagementView({super.key});

  @override
  State<PatientAppointmentManagementView> createState() =>
      _PatientAppointmentManagementViewState();
}

class _PatientAppointmentManagementViewState
    extends State<PatientAppointmentManagementView>
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              // First row with Filter and Refresh buttons
              Container(
              ...
              SizedBox(height: 16),
              // Second row with "Buat Janji" button aligned to the right
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Navigator.of(context).pushNamed(RouteConstant.patient_doctorListView);
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent,
                        foregroundColor: Colors.white,
